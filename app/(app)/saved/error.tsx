...
export default function SavedError({
  ...
  useEffect(() => {
    console.error('[saved] error de ruta:', error)
  }, [error])
  ...
  return (
    <div className="mx-auto w-full max-w-5xl space-y-8 px-4 py-6 md:px-8 md:py-10">
      ...
      <div className="flex flex-col items-center justify-center gap-3 py-16 text-center">
        ...
        <p className="text-sm font-medium text-foreground">No pudimos cargar tus guardados</p>
        <p className="max-w-sm text-xs text-muted-foreground">
          Algo falló al traer tus outputs guardados. Probá de nuevo en un momento.
        </p>
